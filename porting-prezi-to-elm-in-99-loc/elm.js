...
var _user$project$Xml$foldl = F3(
			...
			switch (_p0.ctor) {
				...
				case 'Object':
					return A3(
						...
						F2(
							function (elm, b) {
								return A3(_user$project$Xml$foldl, fn, b, elm);
							}),
						A2(fn, value, init),
						_p0._0);
				default:
					return A2(fn, _p0, init);
			}
		}
	});
var _user$project$Xml$DocType = F2(
	function (a, b) {
		return {ctor: 'DocType', _0: a, _1: b};
	});
var _user$project$Xml$Object = function (a) {
	return {ctor: 'Object', _0: a};
};
var _user$project$Xml$BoolNode = function (a) {
	return {ctor: 'BoolNode', _0: a};
};
var _user$project$Xml$FloatNode = function (a) {
	return {ctor: 'FloatNode', _0: a};
};
var _user$project$Xml$IntNode = function (a) {
	return {ctor: 'IntNode', _0: a};
};
var _user$project$Xml$StrNode = function (a) {
	return {ctor: 'StrNode', _0: a};
};
var _user$project$Xml$Tag = F3(
	function (a, b, c) {
		return {ctor: 'Tag', _0: a, _1: b, _2: c};
	});
var _user$project$Xml$map = F2(
	function (fn, value) {
		var _p1 = value;
		switch (_p1.ctor) {
			case 'Tag':
				return fn(
					A3(
						_user$project$Xml$Tag,
						_p1._0,
						_p1._1,
						A2(_user$project$Xml$map, fn, _p1._2)));
			case 'Object':
				return fn(
					_user$project$Xml$Object(
						A2(
							_elm_lang$core$List$map,
							_user$project$Xml$map(fn),
							_p1._0)));
			default:
				return fn(_p1);
		}
...
var _user$project$Xml_Decode$decodeBool = function (str) {
	return _elm_lang$core$Native_Utils.eq(str, 'true') ? _elm_lang$core$Result$Ok(
		_user$project$Xml$BoolNode(true)) : (_elm_lang$core$Native_Utils.eq(str, 'false') ? _elm_lang$core$Result$Ok(
		_user$project$Xml$BoolNode(false)) : _elm_lang$core$Result$Err('Not a bool'));
};
var _user$project$Xml_Decode$decodeFloat = function (str) {
	var _p0 = _elm_lang$core$String$toFloat(str);
	if (_p0.ctor === 'Err') {
		return _elm_lang$core$Result$Err(_p0._0);
	} else {
		return _elm_lang$core$Result$Ok(
			_user$project$Xml$FloatNode(_p0._0));
	}
};
var _user$project$Xml_Decode$decodeInt = function (str) {
	var _p1 = _elm_lang$core$String$toInt(str);
	if (_p1.ctor === 'Err') {
		return _elm_lang$core$Result$Err(_p1._0);
	} else {
		return _elm_lang$core$Result$Ok(
			_user$project$Xml$IntNode(_p1._0));
	}
};
var _user$project$Xml_Decode$decodeString = function (str) {
	return _elm_lang$core$Result$Ok(
		_user$project$Xml$StrNode(str));
};
var _user$project$Xml_Decode$propRegex = _elm_lang$core$Regex$regex(' .+?=\".+?\"');
var _user$project$Xml_Decode$decodeProps = function (str) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
		...
		{
			ctor: '::',
			_0: _user$project$Xml_Decode$decodeBool,
			_1: {
				ctor: '::',
				_0: _user$project$Xml_Decode$decodeInt,
				_1: {
					ctor: '::',
					_0: _user$project$Xml_Decode$decodeFloat,
					_1: {
						ctor: '::',
						_0: _user$project$Xml_Decode$decodeString,
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Xml_Decode$parseProps = _elm_lang$core$List$filterMap(
	function (n) {
		...
		if (((_p3.ctor === '::') && (_p3._1.ctor === '::')) && (_p3._1._1.ctor === '[]')) {
			...
			var _p4 = _user$project$Xml_Decode$decodeProps(withoutQuotes);
			if (_p4.ctor === 'Err') {
				return _elm_lang$core$Maybe$Nothing;
			} else {
				return _elm_lang$core$Maybe$Just(
...
var _user$project$Xml_Decode$findProps = function (_p5) {
	return _elm_lang$core$Dict$fromList(
		_user$project$Xml_Decode$parseProps(
			A2(
				_elm_lang$core$List$map,
				function (_p6) {
				...
				A3(
					...
					_user$project$Xml_Decode$propRegex,
					function (s) {
...
var _user$project$Xml_Decode$CloseTag = {ctor: 'CloseTag'};
var _user$project$Xml_Decode$OpenTag = {ctor: 'OpenTag'};
var _user$project$Xml_Decode$parseSlice = F3(
	function (first, firstClose, trimmed) {
		...
		var afterOpen = A2(
			...
			A3(
				...
				A2(_elm_lang$core$Debug$log, 'first', first) + 1,
				_elm_lang$core$String$length(trimmed),
				A2(_elm_lang$core$Debug$log, 'trimmed', trimmed)));
		...
		var closeTags = A2(
			...
			F2(
				function (v0, v1) {
					return {ctor: '_Tuple2', _0: v0, _1: v1};
				})(_user$project$Xml_Decode$CloseTag),
			A2(
				_elm_lang$core$Debug$log,
				'closeTags',
		...
		var openTags = A2(
			...
			function (_p9) {
				return A2(
					...
					_user$project$Xml_Decode$OpenTag,
					function (_) {
						return _.index;
					}(_p9));
			},
		...
		var props = _user$project$Xml_Decode$findProps(words);
		...
		if (_p10.ctor === 'Nothing') {
			return A2(_elm_lang$core$String$startsWith, '?', tagName) ? _elm_lang$core$Result$Ok(
				{
					ctor: '_Tuple2',
					_0: A2(_user$project$Xml$DocType, tagName, props),
					_1: firstClose + 1
			...
			var _p11 = _user$project$Xml_Decode$decodeChildren(contents);
			if (_p11.ctor === 'Err') {
				...
				return _elm_lang$core$Result$Ok(
					{
						ctor: '_Tuple2',
						_0: A3(_user$project$Xml$Tag, tagName, props, _p11._0),
						_1: _p12 + _elm_lang$core$String$length(closeTag)
					});
			}
		}
	});
var _user$project$Xml_Decode$decodeChildren = function (str) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (decoder, val) {
		...
		{
			ctor: '::',
			_0: _user$project$Xml_Decode$decode,
			_1: {
				ctor: '::',
				_0: _user$project$Xml_Decode$decodeInt,
				_1: {
...
var _user$project$Xml_Decode$decode = function (text) {
	...
	if (_p14 === '') {
		...
		return A2(
			...
			_user$project$Xml$Object,
			_user$project$Xml_Decode$actualDecode(_p14));
	}
};
var _user$project$Xml_Decode$actualDecode = function (text) {
	...
	if (((_p15.ctor === '_Tuple2') && (_p15._0.ctor === '::')) && (_p15._1.ctor === '::')) {
		return A2(
			...
			function (_p16) {
				var _p17 = _p16;
				var _p20 = _p17._0;
				var _p18 = _user$project$Xml_Decode$actualDecode(
					A3(
						_elm_lang$core$String$slice,
						_p17._1,
			...
			A2(
				_elm_lang$core$Debug$log,
				'parseSlice',
				A3(_user$project$Xml_Decode$parseSlice, _p15._0._0, _p15._1._0, text)));
	} else {
		return _elm_lang$core$Result$Err('Nothing left');
	}
};

var _user$project$Parse$view = function (_p0) {
	var _p1 = _p0;
	return _p1.slides(_p1.current);
};
var _user$project$Parse$toAttr = function (_p2) {
	return A2(
		_elm_lang$core$List$map,
		function (_p3) {
			var _p4 = _p3;
...
var _user$project$Parse$frame2Viewbox = function (current) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
...
var _user$project$Parse$frame2Matrix = function (_p6) {
	var _p7 = _p6;
	return {
		ctor: '_Tuple3',
...
var _user$project$Parse$map6 = F7(
...
var _user$project$Parse$floatRegex = _elm_lang$core$Regex$regex('[-+]?[0-9]*\\.?[0-9]+([eE][-+]?[0-9]+)?');
var _user$project$Parse$numbers2 = function (op) {
	var _p12 = A2(
		_elm_lang$core$Debug$log,
		'floatRegex',
		A3(
			...
			_user$project$Parse$floatRegex,
			op));
	if (_p12.ctor === '::') {
...
var _user$project$Parse$numbers6 = function (op) {
...
var _user$project$Parse$op2Matrix = function (op) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		...
		A2(_elm_lang$core$String$startsWith, 'translate', op) ? A2(
			...
			_user$project$Parse$numbers6(op)) : _elm_lang$core$Maybe$Nothing))))));
};
var _user$project$Parse$attr2Matrix = function (attr) {
			...
			F2(
				function (_p21, matrix) {
					...
					return A2(
						...
						matrix,
						_user$project$Parse$op2Matrix(_p22.match));
				}),
			_Zinggi$elm_webgl_math$Matrix3$identity,
			A3(
				_elm_lang$core$Regex$find,
...
var _user$project$Parse$findNumber = function (children) {
	findNumber:
	while (true) {
...
var _user$project$Parse$getFloat = F2(
	function (key, attr) {
		var _p24 = A2(
			_elm_lang$core$Debug$log,
			'getFloat',
...
var _user$project$Parse$duration = 2000;
var _user$project$Parse$Frame = F4(
	function (a, b, c, d) {
		return {x: a, y: b, w: c, h: d};
	});
var _user$project$Parse$matrix2Frame = function (_p25) {
	var _p26 = _p25;
	return A4(_user$project$Parse$Frame, _p26._2._0, _p26._2._1, _p26._0._0, _p26._1._1);
};
var _user$project$Parse$transformFrame = F2(
	function (matrix, frame) {
		return A2(
			_elm_lang$core$Debug$log,
			'newframe',
			_user$project$Parse$matrix2Frame(
				A2(
					_Zinggi$elm_webgl_math$Matrix3$mul,
					A2(
						_elm_lang$core$Debug$log,
						'oldFrame',
						_user$project$Parse$frame2Matrix(frame)),
					matrix)));
	});
var _user$project$Parse$foldFrame = F2(
	function (child, _p27) {
		var _p28 = _p27;
		var _p36 = _p28._0;
		var _p35 = _p28._1;
		...
		if (_p29.ctor === 'Tag') {
			var _p34 = _p29._0;
			var _p33 = _p29._1;
			if (_elm_lang$core$Native_Utils.eq(_p34, 'rect')) {
				var _p30 = A2(_elm_lang$core$Debug$log, 'rect found', _p33);
				var _p31 = A2(_elm_lang$core$Dict$get, 'style', _p33);
				if ((_p31.ctor === 'Just') && (_p31._0.ctor === 'StrNode')) {
					return (!A2(_elm_lang$core$String$contains, 'stroke:#ff0000', _p31._0._0)) ? {ctor: '_Tuple2', _0: _p36, _1: _p35} : {
						ctor: '_Tuple2',
						_0: _p36,
						_1: A2(
										...
										return A2(
											...
											function (width) {
												return A2(
													...
													function (height) {
														return _elm_lang$core$Maybe$Just(
															A4(_user$project$Parse$Frame, x, y, width, height));
													},
													A2(_user$project$Parse$getFloat, 'height', _p33));
											},
											A2(_user$project$Parse$getFloat, 'width', _p33));
									},
									A2(_user$project$Parse$getFloat, 'y', _p33));
							},
							A2(_user$project$Parse$getFloat, 'x', _p33))
					};
				} else {
					return {ctor: '_Tuple2', _0: _p36, _1: _p35};
				}
			} else {
				if (_elm_lang$core$Native_Utils.eq(_p34, 'text')) {
					return {
						ctor: '_Tuple2',
						_0: function () {
							var _p32 = _user$project$Parse$findNumber(_p29._2);
							if (_p32.ctor === 'Just') {
...
var _user$project$Parse$findFrame = F3(
...
var _user$project$Parse$parse = F3(
	function (frames, parentTransformations, value) {
		var _p38 = A2(_elm_lang$core$Debug$log, 'value', value);
		switch (_p38.ctor) {
			case 'Tag':
				var _p43 = _p38._0;
				var _p42 = _p38._2;
				...
				var parentTransformations_ = A2(
					_Zinggi$elm_webgl_math$Matrix3$mul,
					_user$project$Parse$attr2Matrix(_p41),
					parentTransformations);
				var _p39 = A3(_user$project$Parse$findFrame, _p43, _p41, _p42);
					...
					return {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: _p39._0._0,
								_1: A2(_user$project$Parse$transformFrame, parentTransformations_, _p39._1._0)
							},
							_1: frames
						}
					};
				} else {
					var _p40 = A3(_user$project$Parse$parse, frames, parentTransformations_, _p42);
					var nodes = _p40._0;
					var frames_ = _p40._1;
					return {
						ctor: '_Tuple2',
						_0: {
							...
							_0: A3(
								...
								_p43,
								_user$project$Parse$toAttr(_p41),
								nodes),
							_1: {ctor: '[]'}
						},
						_1: frames_
				...
				return A2(
					...
					A2(
						...
						_elm_lang$core$List$unzip(
							A2(
								_elm_lang$core$List$map,
								A2(_user$project$Parse$parse, frames, parentTransformations),
								_p38._0))));
			case 'StrNode':
				return {
					ctor: '_Tuple2',
						...
						_0: A2(
							_elm_lang$svg$Svg$tspan,
							{
								...
								_0: A2(
									_elm_lang$virtual_dom$VirtualDom$property,
									'innerHTML',
									_elm_lang$core$Json_Encode$string(_p38._0)),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
...
var _user$project$Parse$parseRoot = function (value) {
	var isSvgTag = function (item) {
		var _p44 = item;
		if ((_p44.ctor === 'Tag') && (_p44._0 === 'svg')) {
			return true;
		} else {
			return false;
		}
	...
	if (_p46.ctor === 'Object') {
		var _p47 = A2(
			_elm_lang$core$Debug$log,
			'filtered',
			A2(_elm_lang$core$List$filter, isSvgTag, _p46._0));
		if (((_p47.ctor === '::') && (_p47._0.ctor === 'Tag')) && (_p47._0._0 === 'svg')) {
			var _p49 = _p47._0._1;
			var _p48 = A3(
				_user$project$Parse$parse,
				{ctor: '[]'},
				_user$project$Parse$attr2Matrix(_p49),
				_p47._0._2);
			var nodes = _p48._0;
			var frames = _p48._1;
			return {
				...
				_0: function (frame) {
					return A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$Parse$toAttr(_p49),
							{
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$viewBox(
									_user$project$Parse$frame2Viewbox(frame)),
								_1: {
									ctor: '::',
...
var _user$project$Parse$Model = F4(
	function (a, b, c, d) {
		return {current: a, frames: b, animation: c, slides: d};
	});
var _user$project$Parse$init = A4(
	_user$project$Parse$Model,
	A4(_user$project$Parse$Frame, 0, 0, 0, 0),
	{ctor: '[]'},
	_elm_lang$core$Maybe$Nothing,
	_elm_lang$core$Basics$always(
		_elm_lang$virtual_dom$VirtualDom$text('Please wait. SVG is loading.')));
var _user$project$Parse$update = F2(
	function (msg, model) {
		...
		var calcDiff = F3(
			function (progress, current, target) {
				return A4(_user$project$Parse$Frame, current.x + ((target.x - current.x) * progress), current.y + ((target.y - current.y) * progress), current.w + ((target.w - current.w) * progress), current.h + ((target.h - current.h) * progress));
			});
		var calcProgress = F2(
			function (oldProgress, diff) {
				return A2(_elm_lang$core$Basics$min, 1, oldProgress + (diff / _user$project$Parse$duration));
			});
		var _p50 = A2(_elm_lang$core$Debug$log, 'msg', msg);
		switch (_p50.ctor) {
			case 'Load':
				var _p51 = _p50._0;
				if (_p51.ctor === 'Err') {
					...
					var _p53 = function (result) {
						var _p54 = result;
						if (_p54.ctor === 'Ok') {
							return {
								ctor: '_Tuple2',
								_0: _p54._0._0,
								_1: A2(_elm_lang$core$Debug$log, 'Frames', _p54._0._1)
							};
						} else {
							return {
								ctor: '_Tuple2',
								_0: function (_p55) {
									return _elm_lang$virtual_dom$VirtualDom$text(_p54._0);
								},
								_1: {ctor: '[]'}
							};
						}
						...
						A2(
							_elm_lang$core$Result$map,
							_user$project$Parse$parseRoot,
							_user$project$Xml_Decode$decode(_p51._0)));
					var slides = _p53._0;
					var frames = _p53._1;
					var model = function () {
						var _p56 = frames;
						if (_p56.ctor === '::') {
							return A4(_user$project$Parse$Model, _p56._0, _p56._1, _elm_lang$core$Maybe$Nothing, slides);
						} else {
							return _user$project$Parse$init;
						}
					}();
			...
			case 'Forth':
				return {
					ctor: '_Tuple2',
					_0: function () {
						var _p57 = model.frames;
						if (_p57.ctor === '::') {
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									animation: _elm_lang$core$Maybe$Just(
										{ctor: '_Tuple2', _0: 0, _1: _p57._0}),
									frames: A2(
										_elm_lang$core$Basics_ops['++'],
										_p57._1,
										{
			...
			case 'Back':
				return {
					ctor: '_Tuple2',
					_0: function () {
						var _p58 = _elm_lang$core$List$reverse(model.frames);
						if (_p58.ctor === '::') {
							return _elm_lang$core$Native_Utils.update(
								model,
								{
									animation: _elm_lang$core$Maybe$Just(
										{ctor: '_Tuple2', _0: 0, _1: _p58._0}),
									frames: {
										ctor: '::',
										_0: targetOrCurrent(model),
										_1: _elm_lang$core$List$reverse(_p58._1)
									}
								});
						} else {
							return model;
			...
			default:
				...
				if (_p59.ctor === 'Nothing') {
					...
					if (_elm_lang$core$Native_Utils.eq(_p60, 1)) {
						...
						var newProgress = A2(calcProgress, _p60, _p50._0);
						var easedProgress = _elm_community$easing_functions$Ease$inOutQuad(newProgress);
						var current = A3(calcDiff, easedProgress, model.current, _p61);
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									current: current,
									animation: _elm_lang$core$Maybe$Just(
										{ctor: '_Tuple2', _0: newProgress, _1: _p61})
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
...
var _user$project$Parse$Load = function (a) {
	return {ctor: 'Load', _0: a};
};
var _user$project$Parse$initModel = function (_p62) {
	var _p63 = _p62;
	return {
		ctor: '_Tuple2',
		_0: _user$project$Parse$init,
		_1: A2(
			_elm_lang$http$Http$send,
			_user$project$Parse$Load,
			_elm_lang$http$Http$getString(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						'?',
						_elm_lang$core$Basics$toString(_p63.time)))))
	};
};
var _user$project$Parse$Back = {ctor: 'Back'};
var _user$project$Parse$Forth = {ctor: 'Forth'};
var _user$project$Parse$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Parse$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: function () {
				var _p64 = model.animation;
				if (_p64.ctor === 'Nothing') {
					return _elm_lang$core$Platform_Sub$none;
				} else {
					return _elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Parse$Tick);
				}
			}(),
			_1: {
				ctor: '::',
				_0: _elm_lang$mouse$Mouse$clicks(
					function (_p65) {
						return _user$project$Parse$Forth;
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$keyboard$Keyboard$downs(
						function (code) {
							var _p66 = A2(_elm_lang$core$Debug$log, 'code', code);
							switch (_p66) {
								case 37:
									return _user$project$Parse$Back;
								case 39:
									return _user$project$Parse$Forth;
								default:
									return _user$project$Parse$Tick(0);
							}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Parse$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Parse$initModel, update: _user$project$Parse$update, subscriptions: _user$project$Parse$subscriptions, view: _user$project$Parse$view})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (file) {
			return A2(
...
var Elm = {};
Elm['Parse'] = Elm['Parse'] || {};
if (typeof _user$project$Parse$main !== 'undefined') {
    _user$project$Parse$main(Elm['Parse'], 'Parse', undefined);
}
